...
$query = "SELECT * FROM conceptuals ORDER BY id DESC;";
...
<body>
    <div class="nav">
        <div class="logo">
            <a href="<?php echo 'adconceptuals.php?user='.$_GET['user'] ?>"><h2>HDT - Conceptuals</h2></a>
        </div>
        <div class="links">
                <ul>
    ...
    <div class="body-contents">
        <div class="head">
            <h3>Review Conceptuals</h3>
        </div>

        <div class="table">
          <table>
            <tr>
                 <th>Conceptuals ID</th>
                 <th>Name of File</th>
                 <th>Subject</th>
                 <th>Link</th>
                 <th>Actions</th>
            ...
            <td>'.$row['title'].'</td>
            <td>'.$row['subjects'].'</td>
            <td><a href="conceptuals/'.$row['title'].'" class="edit" download>Download</td>
            <td>
                <a href="clearconceptual.php?id='.$row['id'].'&title='.$row['title'].'&user='.$_GET['user'].'" class="decline">Delete</a>
            </td>
        ';
             } 
        echo '</table>
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Admin - Review Conceptuals</title>
        <style>
            *{
                margin: 0;
                padding: 0;
        ...
        <div class="nav">
        <div class="logo">
            <a href="adconceptuals.php?user='.$_GET['user'].'"><h2>HDT - Review Conceptuals</h2></a>
        </div>
        <div class="links">
                <ul>
