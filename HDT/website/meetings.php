...
<body>
    <div class="left">
       ...
       <div class="links">
            ...
            <h3 class="active"><a href="meetings.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>"><span><img src="icons/reddit.png" style="height: 23px;padding-right: 1rem;"></span>Available Zoom meetings</a></h3>
    ...
    <div class="body-contents">
        ...
        <?php
             ...
             echo '<tr>
                 ...
                 <td>'.$row2['meetID'].'</td>
                 <td>'.$row2['subjects'].'</td>
                 <td><a href="'.$row2['link'].'" target="_blank" class="accept">Attend</a></td>
             </tr>
        ';
        }
        echo '</table>
...
<div class="left">
        ...
        <div class="links">
                ...
                <h3 class="active"><a href="meetings.php?id='.$_GET['id'].'&paid='.$_GET['paid'].'&user='.$_GET['user'].'"><span><img src="icons/reddit.png" style="height: 23px;padding-right: 1rem;"></span>Available Zoom meetings</a></h3>
