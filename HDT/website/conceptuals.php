<?php
    ...
    $query2 = "SELECT * FROM conceptuals ORDER BY id DESC";
...
<head>
    ...
    <title>Student - Conceptuals</title>
    <style>
        *{
            margin: 0;
            padding: 0;
...
<body>
    <div class="left">
       ...
       <div class="links">
            ...
            <h3 class="active"><a href="conceptuals.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>"><span><img src="icons/about.png" style="height: 23px;padding-right: 1rem;"></span>Conceptuals</a></h3>
            <h3><a href="lectures.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>"><span><img src="icons/youtube.png" style="height: 23px;padding-right: 1rem;"></span>HTD YouTube Lectures</a></h3>
    ...
    <div class="body-contents">
        ...
        <?php
             ...
             <tr>
                ...
                <td>'.$row2['title'].'</td>
                <td>'.$row2['subjects'].'</td>
                <td><a href="conceptuals/'.$row2['title'].'" class="edit" download>Download</a></td>
             </tr>
        ';
        }
        echo '</table>
...
<div class="left">
        ...
        <div class="links">
                ...
                <h3 class="active"><a href="conceptuals.php?id='.$_GET['id'].'&paid='.$_GET['paid'].'&user='.$_GET['user'].'"><span><img src="icons/about.png" style="height: 23px;padding-right: 1rem;"></span>Conceptuals</a></h3>
                <h3><a href="lectures.php?id='.$_GET['id'].'&paid='.$_GET['paid'].'&user='.$_GET['user'].'"><span><img src="icons/youtube.png" style="height: 23px;padding-right: 1rem;"></span>HTD YouTube Lectures</a></h3>
