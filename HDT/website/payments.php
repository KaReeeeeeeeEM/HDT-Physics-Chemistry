...
<head>
    ...
    <title>Student - My Payments</title>
    <style>
        *{
            margin: 0;
            padding: 0;
...
<body>
    <div class="left">
        <div class="details">
        <a href="dashboard.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>" style="text-decoration:none;"><a href="dashboard.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>" style="text-decoration:none;"><h2>Welcome Student <span style="color:green;">#00<?php if(isset($_GET['id'])) echo $_GET['id']; ?></span></h2></a></a>
       ...
       <div class="links">
            ...
            <h3 class="active"><a href="payments.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>"><span><img src="icons/price.png" style="height: 23px;padding-right: 1rem;"></span>Payments</a></h3>
