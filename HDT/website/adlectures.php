<?php 
                        ...
                        if(isset($_POST['create'])){
                            $query = "INSERT INTO lectures(title,host,descriptions,link,subjects) VALUES (?,?,?,?,?);";
                            $stmt = mysqli_prepare($connection,$query);
                            $stmt->bind_param("sssss",$_POST['title'],$_POST['host'],$_POST['descriptions'],$_POST['link'],$_POST['subjects']);
                            $stmt->execute();
                    
                            header('Location:adlectures.php?user='.$_GET['user'].'&status=New '.$_POST['subjects'].' YouTube Video available');
                        } 
    ...
    <body>
        ...
        <script>
            ...
            let disappear = () =>{
                ...
                window.location.href = "adlectures.php?user='.$_GET["user"].'";
            }
        </script>
...
<body>
    <div class="nav">
        <div class="logo">
            <a href="<?php echo 'admindashboard.php?user='.$_GET['user'] ?>"><h2>HDT - Lectures</h2></a>
        </div>
        <div class="links">
                <ul>
        ...
        <div class="body">
                <div class="row" id="meeting">
                    <div class="row-head">
                        <h2><span><img src="icons/file-small.png" style="height: 25px;"></span> New YouTube Video</h2>
                    </div>
                    ...
                    <div class="button">
                        <a href="#">Make a YouTube Lecture</a>
                    </div>
                </div>

                <div class="row" id="notify">
                    <div class="row-head">
                        <h2><span><img src="icons/file-small.png" style="height: 25px;"></span> Upcoming Lectures</h2>
                    </div>
                    <div class="row-content">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Possimus nisi accusamus architecto beatae delectus doloremque magnam laborum eligendi, nostrum dolorum officiis perferendis facilis nobis totam. Harum voluptatum debitis eius voluptatibus.</p>
                    </div>
                    <div class="button" id="button1">
                        <a href="<?php echo 'adlectures.php?user='.$_GET['user'] ?>">Back to Lectures</a>
                    </div>
                ...
                <div class="row" id="history">
                    ...
                    <?php 
                        ...
                        ?>
                        <h2><span><img src="icons/file-small.png" style="height: 25px;"></span> Lecture Videos History</h2>
                    </div>
                    <div class="row-content">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Possimus nisi accusamus architecto beatae delectus doloremque magnam laborum eligendi, nostrum dolorum officiis perferendis facilis nobis totam. Harum voluptatum debitis eius voluptatibus.</p>
                    </div>
                    <div class="button">
                        <a href="adlecturehistory.php?user=<?php echo $_GET['user'] ?>">My Lectures</a>
                    </div>
                </div>

                <div class="row" id="meetform">
                    <form method="post">
                        <input type="text" autocomplete="off" placeholder="Title" name="title" id="one" autofocus required> <br>
                        ...
                        <input type="text" autocomplete="off" placeholder="YouTube Link" name="link" id="four" required> <br>
                        <input type="text" autocomplete="off" placeholder="Subject" name="subjects" id="five" required> <br>
                        <input type="submit" value="Add Lecture" name="create">
                    </form>
                </div>
    </div>
    <script>
