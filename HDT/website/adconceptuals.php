    ...
    <body>
        ...
        <script>
            ...
            let disappear = () =>{
                ...
                window.location.href = "adconceptuals.php?user='.$_GET["user"].'";
            }
        </script>
...
<body>
    ...
    <div class="body">
                ...
                <div class="row" id="history">
                    <div class="row-head">
                        <h2><span><img src="icons/about.png" style="height: 25px;"></span> Review Conceptuals</h2>
                    </div>
                    ...
                    <div class="button">
                        <a href="adconceptualshistory.php?user=<?php echo $_GET['user'] ?>">See my Conceptuals</a>
                    </div>
                </div>

                <div class="row" id="notify">
                    <div class="row-head">
                        <h2><span><img src="icons/about.png" style="height: 25px;"></span> Post New Conceptuals</h2>
                    </div>
                    <div class="row-content">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Possimus nisi accusamus architecto beatae delectus doloremque magnam laborum eligendi, nostrum dolorum officiis perferendis facilis nobis totam. Harum voluptatum debitis eius voluptatibus.</p>
                    </div>
                    <div class="button" id="button1">
                        <a href="<?php echo 'adconceptuals.php?user='.$_GET['user'] ?>">Back to Conceptuals</a>
                    </div>
                ...
                <div class="row" id="meetform">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" value="Post Conceptuals" name="post" id="three">
                        </form>
                </div>
    </div>
    <script>
