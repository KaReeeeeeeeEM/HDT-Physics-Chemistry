<?php
    ...
    $query2 = "SELECT * FROM notes ORDER BY id DESC";
...
<head>
    ...
    <title>Student - Posted Notes</title>
    <style>
        *{
            margin: 0;
            padding: 0;
...
<body>
    <div class="left">
       ...
       <div class="links">
            <h3 class="active"><a href="notes.php?id=<?php echo $_GET['id'] ?>&paid=<?php echo$_GET['paid'] ?>&user=<?php echo $_GET['user'] ?>"><span><img src="icons/file-small.png" style="height: 23px;padding-right: 1rem;"></span>View Notes</a></h3>
    ...
    <div class="body-contents">
        ...
        <?php
             ...
             <tr>
                ...
                <td>'.$row2['title'].'</td>
                <td>'.$row2['subjects'].'</td>
                <td><a href="notes/'.$row2['title'].'" class="edit" download>Download</a></td>
             </tr>
        ';
        }
        echo '</table>
...
<body>
    <div class="left">
        ...
        <div class="links">
                <h3 class="active"><a href="notes.php?id='.$_GET['id'].'&paid='.$_GET['paid'].'&user='.$_GET['user'].'"><span><img src="icons/file-small.png" style="height: 23px;padding-right: 1rem;"></span>View Notes</a></h3>
