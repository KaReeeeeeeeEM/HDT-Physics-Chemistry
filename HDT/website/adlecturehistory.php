...
<head>
    ...
    <title>Admin - Lecture History</title>
    <style>
        *{
            margin: 0;
            padding: 0;
...
<body>
    <div class="nav">
        <div class="logo">
            <a href="<?php echo 'adlectures.php?user='.$_GET['user'] ?>"><h2>HDT - Lecture History</h2></a>
        </div>
        <div class="links">
                <ul>
    ...
    <div class="body-contents">
        ...
        <div class="table">
          <table>
            ...
            <td>'.$row['subjects'].'</td>
            <td><a href="'.$row['link'].'" class="edit">View</td>
            <td>
                <a href="clearlecture.php?id='.$row['id'].'&title='.$row['title'].'&user='.$_GET['user'].'" class="decline">Clear Lecture</a>
            </td>
        ';
             } 
        echo '</table>
    ...
    <head>
        ...
        <div class="nav">
        <div class="logo">
            <a href="adlectures.php?user='.$_GET['user'].'"><h2>HDT - Lecture History</h2></a>
        </div>
        <div class="links">
                <ul>
